...
class Settings(BaseSettings):
    ...
    chatbot_cerebras_model: str = Field(default='qwen-3-235b-a22b-instruct-2507', alias='CHATBOT_CEREBRAS_MODEL')
    chatbot_history_window: int = Field(default=12, alias='CHATBOT_HISTORY_WINDOW')
